/**
 * CustomJacksonJsonProvider.java class file
 */
...
public class CustomJacksonJsonProvider extends JacksonJsonProvider {
	...
	protected boolean isJsonType(MediaType mediaType) {
		...
		return mediaType != null
				&& (mediaType.getType().equalsIgnoreCase("text") && mediaType.getSubtype().equals("javascript"))
				|| (mediaType.getType().equalsIgnoreCase("application") && mediaType.getSubtype().equals("x-javascript"))
				|| (mediaType.getType().equalsIgnoreCase("text") && mediaType.getSubtype().equals("plain"));
	}
}