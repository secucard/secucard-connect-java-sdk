...
public class ContainersService extends ProductService<Container> {
  ...
  public static final ServiceMetaData<Container> META_DATA = new ServiceMetaData<>("payment", "containers", Container.class);
  ...
  /**
   * Creating a payment container. The container data must at least provide a valid IBAN in private data! See {@link
   * com.secucard.connect.product.payment.model.Data}, all other data is optional. Returns validated and completed container data on success. Throws
   * exception when validation failed, see "throws" section.
   *
   ...
   * @throws com.secucard.connect.client.APIError if a error happens. userMessage field has the reason, like "invalid IBAN and BIC combination".
   */
